...
namespace InternshipPortal.API.Services
{
    ...
    {
        Task<Message> SendMessageAsync(int senderUserId, int receiverUserId, string messageText, string? subject = null, int? applicationId = null, MessageType? messageType = null, string? fileUrl = null, string? fileName = null, string? fileType = null, long? fileSize = null);
